        ...
        <div>
            <div className="bg-blue-600 w-screen flex p-5 justify-between items-center sm:text-xl md:text-2xl">
                ...
                <div className="md:ml-auto flex flex-wrap text-white justify-center cursor-pointer items-center ">
                    ...
                    <div onClick={() => ShowThefavorites()} className='mr-5 flex cursor-pointer'>
                       <FaRegHeart size={26} />
                    </div>
                    <div
                    ...
                    >
                        <input
                            type="text" autoCapitalize='false' onChange={(e) => setVal(e.target.value.toLowerCase())} onKeyDown={handleKeyDown}
